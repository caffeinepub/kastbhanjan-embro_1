...
export class Backend implements backendInterface {
    ...
    async getAllProductsByRating(): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllProductsByRating();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitCustomOrder(arg0: CustomOrder): Promise<string> {
        if (this.processError) {
            try {
